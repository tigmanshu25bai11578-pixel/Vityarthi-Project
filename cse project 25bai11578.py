...
def hospital_billing_system():
    ...
    while True:
        ...
        BodyTemperature = int(input("Enter the patient Body Temperature: "))
        BloodPressure = input("Enter patient Blood Pressure: ")

        PresentCondition = input("Enter patient condition (Critical, Stable): ")
        if PresentCondition == "Critical":
            print("Admit patient to ICU")
        else:
            print("Admit patient to General Ward")

        print("\nWard Types (per day): 1: 1,800 | 2: 2,500 | 3: 3,500 | 4: 5,000")

        sel = int(input("Select ward (1-4): "))
